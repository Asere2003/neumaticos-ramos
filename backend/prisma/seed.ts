import { PrismaClient, TipoBloqueo, TipoServicio } from '@prisma/client'

import { config } from 'dotenv';

config(); // Carga el .env automáticamente
...
async function main() {
  ...
  const servicios = await Promise.all([
    prisma.servicio.upsert({
      where:  { tipo: TipoServicio.NEUMATICOS },
      update: {},
      create: {
        tipo:        TipoServicio.NEUMATICOS,
        nombre:      'Neumáticos',
    ...
    prisma.servicio.upsert({
      where:  { tipo: TipoServicio.ALINEACION },
      update: {},
      create: {
        tipo:        TipoServicio.ALINEACION,
    ...
    prisma.servicio.upsert({
      where:  { tipo: TipoServicio.EQUILIBRADO },
      update: {},
      create: {
        tipo:        TipoServicio.EQUILIBRADO,
        nombre:      'Equilibrado',
    ...
    prisma.servicio.upsert({
      where:  { tipo: TipoServicio.LLANTAS },
      update: {},
      create: {
        tipo:        TipoServicio.LLANTAS,
        nombre:      'Llantas',
  ...
  // ----------------------------------------------------------
  // 4. FESTIVOS 2025 MADRID
  // ----------------------------------------------------------
  const festivos2025 = [
    { fecha: '2025-01-01', motivo: 'Año Nuevo',                    tipo: TipoBloqueo.FESTIVO_NACIONAL },
    { fecha: '2025-01-06', motivo: 'Reyes Magos',                  tipo: TipoBloqueo.FESTIVO_NACIONAL },
    { fecha: '2025-04-18', motivo: 'Viernes Santo',                tipo: TipoBloqueo.FESTIVO_NACIONAL },
    { fecha: '2025-05-01', motivo: 'Día del Trabajador',           tipo: TipoBloqueo.FESTIVO_NACIONAL },
    { fecha: '2025-05-02', motivo: 'Día de la Comunidad de Madrid',tipo: TipoBloqueo.FESTIVO_LOCAL    },
    { fecha: '2025-08-15', motivo: 'Asunción de la Virgen',        tipo: TipoBloqueo.FESTIVO_NACIONAL },
    { fecha: '2025-10-12', motivo: 'Fiesta Nacional de España',    tipo: TipoBloqueo.FESTIVO_NACIONAL },
    { fecha: '2025-11-01', motivo: 'Todos los Santos',             tipo: TipoBloqueo.FESTIVO_NACIONAL },
    { fecha: '2025-11-10', motivo: 'Almudena — Festivo Madrid',    tipo: TipoBloqueo.FESTIVO_LOCAL    },
    { fecha: '2025-12-06', motivo: 'Día de la Constitución',       tipo: TipoBloqueo.FESTIVO_NACIONAL },
    { fecha: '2025-12-08', motivo: 'Inmaculada Concepción',        tipo: TipoBloqueo.FESTIVO_NACIONAL },
    { fecha: '2025-12-25', motivo: 'Navidad',                      tipo: TipoBloqueo.FESTIVO_NACIONAL },
  ]
